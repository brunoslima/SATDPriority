...
public class Core {
    ...
    public void makeAssociationContext(Data data){
        ...
        for(int i = 0; i < data.getSatdCollection().size(); i++) {
            ...
            System.out.println(data.getSatdCollection().get(i).getDescription());
            ...
            //System.out.println("Before = " + listIssueAux.size());
    ...
    public void show() {
        ...
        for(int i = 0; i < this.associationCollection.size(); i++){
            ...
            result += this.associationCollection.get(i).showID() + "\n";
        }
