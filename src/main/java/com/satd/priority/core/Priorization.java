...
public class Priorization {
    ...
    public static double getPriorityNivel(AssociationCore a) {
        ...
        //priorityNivel = getEquationSATD(a.getSatdInstance().getDescription()) + getEquationIssues(a.getIssuesInstances());  //ANTIGA
        if(getEquationIssues(a.getIssuesInstances()) != 0) {

            priorityNivel = getEquationSATD(a.getSatdInstance().getDescription()) * getEquationIssues(a.getIssuesInstances()); //NOVA
        }
        else {
    ...
    public static double getEquationSATD(String description) {
        ...
        //dictionary
		/*
		if(description.contains("serious")) priority += 10000;
		if(description.contains("urgent")) priority += 10000;
		if(description.contains("fundamental")) priority += 10000;
		if(description.contains("terrible")) priority += 10000;
		if(description.contains("fugly") || description.contains("horrible")) priority += 10000;
		if(description.contains("add it now")) priority += 10000;
		if(description.contains("system malfunctioning")) priority += 10000;
		if(description.contains("fail") || description.contains("fails") || description.contains("failure")) priority += 10000;
		if(description.contains("fatal")) priority += 10000;
		if(description.contains("problematic") || description.contains("problem") || description.contains("issue")) priority += 10000;
		if(description.contains("bug") || description.contains("bugfix")) priority += 10000;
		if(description.contains("error") || description.contains("error handling")) priority += 10000;
		if(description.contains("broken")) priority += 10000;
		if(description.contains("exception")) priority += 10000;
		//if(description.contains("test failure") || description.contains("test fails")) priority += 10000;
		//if(description.contains("fix testcase")) priority += 10000;
		if(description.contains("untested") || (description.contains("not") && description.contains("tested")) || description.contains("needs tested")) priority += 10000;
		if(description.contains("more tests")) priority += 10000;
		if(description.contains("improve this test")) priority += 10000;
		if(description.contains("yuck")) priority += 10000;
		if(description.contains("ugly")) priority += 10000;
		if(description.contains("stupid")) priority += 10000;
		if(description.contains("junk")) priority += 10000;
		if(description.contains("not work")) priority += 10000;
		if(description.contains("need the correctness")) priority += 10000;
		if(description.contains("wrong") || description.contains("wrong result") || description.contains("this is wrong") || description.contains("probably wrong")) priority += 10000;
		if(description.contains("implement") && description.contains("properly")) priority += 10000;
		if(description.contains("improve this a lot") || description.contains("improve")) priority += 10000;
		if(description.contains("tidy this up")) priority += 10000;
		if(description.contains("fixme") || description.contains("fix") || description.contains("fix it") || description.contains("must fix it") || description.contains("to fix") || description.contains("we ought to fix")) priority += 10000;
		if(description.contains("killing")) priority += 10000;
		if(description.contains("slow")) priority += 10000;
		if(description.contains("inefficient")) priority += 10000;
		if(description.contains("optimize")) priority += 10000;
		if(description.contains("do this more efficiently")) priority += 10000;
		if(description.contains("check") || description.contains("check this result")) priority += 10000;
		if(description.contains("nasty")) priority += 10000;
		if(description.contains("might hang")) priority += 10000;
		if(description.contains("fragile")) priority += 10000;
		if(description.contains("hack")) priority += 10000;
		if(description.contains("ugliest")) priority += 10000;
		if(description.contains("fugly code")) priority += 10000;
		if(description.contains("code violates")) priority += 10000;
		if(description.contains("silly")) priority += 10000;
		if(description.contains("don't like")) priority += 10000;
		if(description.contains("does not make sense")) priority += 10000;
		if(description.contains("this needs work")) priority += 10000;
		if(description.contains("find a cleaner way to do this")) priority += 10000;
		if(description.contains("bail out")) priority += 10000;
		*/
    ...
    public static double getEquationIssues(ArrayList<Issue> issues) {
        ...
        for(Issue i : issues) {
            ...
            if(!i.getRework().equals("N")){
                //System.out.println(Integer.parseInt(i.getRework()));
